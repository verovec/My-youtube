...
import nuxt_plugin_vueicon_2b590461 from 'nuxt_plugin_vueicon_2b590461' // Source: ../plugins/vue-icon.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"MyYoutube","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"## Build Setup"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_vueicon_2b590461 === 'function') {
    await nuxt_plugin_vueicon_2b590461(app.context, inject)
  }
